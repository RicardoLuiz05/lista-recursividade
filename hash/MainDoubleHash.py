...
table1.put('Fernanda')
table1.display()
print(f'A posicão do numero 77 é: {table1.get(77)}')
print(f'Removendo o número 77 da carga {table1.remove(77)}')
print(f'As chaves existentes na tabela: {table1.keys()}')
print(f'Posições existentes na tabela: {table1.values()}')
table1.display()
print (f'Copia: {table1.copy()}')
#table1.__len__()
input() 
#table1.display()
#print(table1.__len__())
